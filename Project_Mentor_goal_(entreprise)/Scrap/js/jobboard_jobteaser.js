...
function addContact() {
            ...
            Entreprise = document.querySelector(".jds-Link.jod-Link");
            Poste = document.querySelector('.jds-Text.jds-Text--heading-small.jds-Text--resetSpacing');
            Lieu = document.querySelector(".jod-DescriptionList__item");
            Description = document.querySelector(".jds-Text.jds-Text--normal.jod-WysiwygText")
            Type_de_Contrat = document.querySelector(".jod-DescriptionList__item");
