...
function addContact() {
            ...
            Entreprise = document.querySelector(".name");
            Poste = document.querySelector('.elementor-heading-title.elementor-size-default');
            Lieu = document.querySelector("#wrapper-content > div.elementor.elementor-10831.elementor-location-single.post-13453.job_listing.type-job_listing.status-publish.has-post-thumbnail.hentry.job_listing_category-administration.job_listing_category-business.job_listing_category-developpement-commercial.job_listing_type-cdi.companies-olympique-lyonnais.container.job-type-cdi > div > section.elementor-section.elementor-top-section.elementor-element.elementor-element-5e3de69.elementor-section-full_width.elementor-section-height-default.elementor-section-height-default > div > div > div.elementor-column.elementor-col-25.elementor-top-column.elementor-element.elementor-element-00d1cd0 > div > div > div > div > div > ul > li.location > a");
            Type_de_Contrat = document.querySelector(".job-type.cdi");
