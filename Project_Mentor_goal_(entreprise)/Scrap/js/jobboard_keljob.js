...
function addContact() {
            ...
            Entreprise = document.querySelector("#sticky-apply-form > div.sticky-apply-form > div.sticky-apply-form__company-name > a > span");
            Poste = document.querySelector('.medium-12 columns');
            Lieu = document.querySelector("#wrapper > div.jobs-detail.ng-scope > section > header > div > div > div > div > div > ul > li:nth-child(3)");
            Type_de_Contrat = document.querySelector("#wrapper > div.jobs-detail.ng-scope > section > header > div > div > div > div > div > ul > li:nth-child(2)");
