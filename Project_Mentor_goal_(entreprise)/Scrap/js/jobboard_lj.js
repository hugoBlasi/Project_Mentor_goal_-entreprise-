...
function addContact() {
            ...
            Entreprise = document.querySelector(".no-mb");
            Poste = document.querySelector('.pb.col.big.no-mb');
            Lieu = document.querySelector(".fa.fa-map-marker");
            Description = document.querySelector("#job-description > p:nth-child(2) > span")
            Type_de_Contrat = document.querySelector(".fa.fa-suitcase");
