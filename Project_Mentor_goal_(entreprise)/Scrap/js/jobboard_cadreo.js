...
function addContact() {
            ...
            Entreprise = document.querySelector("body > div.offer--detail > div > div:nth-child(1) > div > div > div.ent > div > p.big.georgia > a");
            Poste = document.querySelector('body > div.offer--detail > div > div:nth-child(1) > div > div > h1');
            Lieu = document.querySelector("body > div.offer--detail > div > div:nth-child(1) > div > div > div.ent > div > p:nth-child(2)");
            Description = document.querySelector("body > div.offer--detail > div > div:nth-child(2) > div > p")
            Type_de_Contrat = document.querySelector("body > div.offer--detail > div > div:nth-child(1) > div > div > div.ent > div > p:nth-child(3)");
