...
function addContact() {
            ...
            Entreprise = document.querySelector("body > main > div > apec-offres > div > apec-detail-emploi > div > div:nth-child(2) > article > div > div > apec-offre-metadata > div > div.card-offer__text > ul > li:nth-child(1)");
            Poste = document.querySelector('.card-title.mt-0');
            Lieu = document.querySelector("body > main > div > apec-offres > div > apec-detail-emploi > div > div:nth-child(2) > article > div > div > apec-offre-metadata > div > div.card-offer__text > ul > li:nth-child(3)");
            Description = document.querySelector("body > main > div > apec-offres > div > apec-detail-emploi > div > div:nth-child(2) > article > div > div > apec-poste-informations > div > div.col-lg-8.border-L > div > p:nth-child(2)")
            Type_de_Contrat = document.querySelector("body > main > div > apec-offres > div > apec-detail-emploi > div > div:nth-child(2) > article > div > div > apec-offre-metadata > div > div.card-offer__text > ul > li:nth-child(2) > span");
