...
function addContact() {
            ...
            Entreprise = document.querySelector(".sc-17gqtt5-6.jOMoqb").innerHTML;
            Poste = document.querySelector('.sc-17gqtt5-7.bSQnUK').innerHTML;
            Lieu = document.querySelector("#prc-1-1-1 > main > div.sc-cxpSdN.sc-iIUQWv.hdl9e2-6.jUAfYu.fZjHgB > div > div.sc-16prvzg-2.ehBnKk > div:nth-child(2) > ul > li:nth-child(2) > span.sc-1lvyirq-2.gRznTA");
            Type_de_Contrat = document.querySelector("#prc-1-1-1 > main > div.sc-cxpSdN.sc-iIUQWv.hdl9e2-6.jUAfYu.fZjHgB > div > div.sc-16prvzg-2.ehBnKk > div:nth-child(2) > ul > li:nth-child(1) > span.sc-1lvyirq-2.gRznTA > span");
