...
function addContact() {
            ...
            Entreprise = document.querySelector(".headerstyle__JobViewHeaderCompany-sc-1ijq9nh-6.vYQlO");
            Poste = document.querySelector('.headerstyle__JobViewHeaderTitle-sc-1ijq9nh-5.jSWmz');
            Lieu = document.querySelector("#__next > div.main-layoutstyles__Layout-sc-1w7iv1n-0.bAlkTK > div > div.jobview-containerstyles__JobViewContainer-sc-16af7k7-1.haJxFt > div.jobview-containerstyles__JobViewContent-sc-16af7k7-2.epELVL > div > div.jobview-containerstyles__DetailsTable-sc-16af7k7-4.SUNAp > div.detailsstyles__DetailsTable-sc-1deoovj-0.jaGgQW > div:nth-child(4) > div.detailsstyles__DetailsTableDetailBody-sc-1deoovj-5.hDKBZO > span");
            Description = document.querySelector(".introText")
            Type_de_Contrat = document.querySelector(".detailsstyles__DetailsTableDetailBody-sc-1deoovj-5.hDKBZO");
