...
function addContact() {
            ...
            Entreprise = document.querySelector(".tw-block.tw-text-lg.tw-leading-4.tw-mb-2.tw-font-medium");
            Poste = document.querySelector('.tw-font-heading.tw-text-4xl.tw-leading-8.sm:tw-text-5xl.sm:tw-leading-9.tw-pb-4.sm:tw-pb-6');
            Lieu = document.querySelector(".tw-text-sans");
            Description = document.querySelector(".tw-text-sans.tw-text-base.tw-mb-6.tw-font-medium")
            Type_de_Contrat = document.querySelector(".tw-block.tw-font-medium");
