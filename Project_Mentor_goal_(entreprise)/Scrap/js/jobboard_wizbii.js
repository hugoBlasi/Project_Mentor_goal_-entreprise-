...
function addContact() {
            ...
            Entreprise = document.querySelector("#layout-main > div > app-layerable > app-modal > div.modal.ng-tns-c89-64.modal--padded > perfect-scrollbar > div > div.ps-content > div > app-view > job-fullweight > article > header > span > a > span");
            Poste = document.querySelector('#layout-main > div > app-layerable > app-modal > div.modal.ng-tns-c89-64.modal--padded > perfect-scrollbar > div > div.ps-content > div > app-view > job-fullweight > article > header > h1');
            Lieu = document.querySelector("#layout-main > div > app-layerable > app-modal > div.modal.ng-tns-c89-64.modal--padded > perfect-scrollbar > div > div.ps-content > div > app-view > job-fullweight > article > header > job-tags > ul > li:nth-child(2) > job-city > span > span > span:nth-child(1)");
            Description = document.querySelector("#layout-main > div > app-layerable > app-modal > div.modal.ng-tns-c89-64.modal--padded > perfect-scrollbar > div > div.ps-content > div > app-view > job-fullweight > article > section:nth-child(6) > p")
            Type_de_Contrat = document.querySelector("#layout-main > div > app-layerable > app-modal > div.modal.ng-tns-c89-64.modal--padded > perfect-scrollbar > div > div.ps-content > div > app-view > job-fullweight > article > header > job-tags > ul > li:nth-child(1) > span");
