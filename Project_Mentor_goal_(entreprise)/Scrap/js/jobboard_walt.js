...
function addContact() {
            ...
            Entreprise = document.querySelector(".Sheet-title");
            Poste = document.querySelector('.HeaderProfile-title.dot');
            Lieu = document.querySelector("#description > div > div:nth-child(3) > div > p:nth-child(2)");
            Description = document.querySelector(".Sheet-description.description")
            Type_de_Contrat = document.querySelector("#description > div > div:nth-child(2) > div.Figures.Sheet-figures > div:nth-child(2) > div:nth-child(2) > p");
