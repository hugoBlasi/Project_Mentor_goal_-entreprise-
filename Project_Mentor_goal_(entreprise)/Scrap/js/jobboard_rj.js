...
function addContact() {
            ...
            Entreprise = document.querySelector("body > header > section.campagne.centered.classic.augmented.modal > h1 > span");
            Poste = document.querySelector('body > main > section.righty > section.content.retrait.modal > ul > li:nth-child(1) > span:nth-child(2)');
            Lieu = document.querySelector("body > main > section.righty > section.content.retrait.modal > ul > li:nth-child(3) > span:nth-child(2)");
            Description = document.querySelector("body > main > section.righty > section:nth-child(1) > p")
            Type_de_Contrat = document.querySelector("body > main > section.righty > section.content.retrait.modal > ul > li:nth-child(5) > span:nth-child(2)");
