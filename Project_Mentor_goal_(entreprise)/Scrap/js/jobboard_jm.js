...
function addContact() {
            ...
            Entreprise = document.querySelector("#__layout > div > main > div > div.job__context.mks-grid > div.job__content.mks-col-12.mks-col-8\@md > div.job__project-on-mobile > div.project > div >");
            Poste = document.querySelector('#__layout > div > main > div > div.job__context.mks-grid > div.job__content.mks-col-12.mks-col-8\@md > div:nth-child(1) > div > div > header > h1');
            Lieu = document.querySelector("#__layout > div > main > div > div.job__context.mks-grid > div.job__content.mks-col-12.mks-col-8\@md > div:nth-child(1) > div > div > header > section > main > div > div > div > div > div:nth-child(3) > div > address");
            Description = document.querySelector("#__layout > div > main > div > div.job__context.mks-grid > div.job__content.mks-col-12.mks-col-8\@md > section > main > div > main > p:nth-child(1) > span")
            Type_de_Contrat = document.querySelector("#__layout > div > main > div > div.job__context.mks-grid > div.job__content.mks-col-12.mks-col-8\@md > div:nth-child(1) > div > div > header > section > main > div > div > div > div > div:nth-child(1) > div");
