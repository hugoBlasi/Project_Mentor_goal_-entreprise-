...
function addContact() {
            ...
            Entreprise = document.querySelector("#job > div > header > p");
            Poste = document.querySelector('#job > div > header > h1');
            Lieu = document.querySelector("#job > div > header > ul.details > li:nth-child(1) > span");
            Description = document.querySelector("#job > div > section.content")
            Type_de_Contrat = document.querySelector("#job > div > header > ul.details > li:nth-child(2)");
